...
Route::middleware(['auth', 'active'])->group(function () {
    ...
    Route::get('/admin/products/import', [ProductImportController::class, 'create'])->name('admin.products.import');
    Route::post('/admin/products/import/preview', [ProductImportController::class, 'preview'])->name('admin.products.import.preview');
    Route::post('/admin/products/import', [ProductImportController::class, 'store'])->name('admin.products.import.store');
    Route::delete('/admin/products/import', [ProductImportController::class, 'destroy'])->name('admin.products.import.destroy');
    Route::get('/admin/products/import/template', [ProductImportController::class, 'template'])->name('admin.products.import.template');
